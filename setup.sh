...
iptables -t nat -A POSTROUTING -s 192.168.22.0/24 -d 0.0.0.0/0 -o ens18 -j MASQUERADE

service pptpd start

#supposedly makes the vpn work better
iptables -I FORWARD -s 192.168.22.0/24 -p tcp -m tcp --tcp-flags FIN,SYN,RST,ACK SYN -j TCPMSS --set-mss 1356
